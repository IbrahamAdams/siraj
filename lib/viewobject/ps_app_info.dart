...
import 'package:flutterbuyandsell/viewobject/item_upload_config.dart';
...
class PSAppInfo extends PsObject<PSAppInfo?> {
    ...
    if (dynamicData != null) {
      return PSAppInfo(
          ...
          packageInAppPurchaseKeyInAndroid:
              dynamicData['package_in_app_purchased_prd_id_android'],
          packageInAppPurchaseKeyInIOS:
              dynamicData['package_in_app_purchased_prd_id_ios']);
    } else {
      return null;
    }
  }
  ...
  Map<String, dynamic>? toMap(dynamic object) {
    if (object != null) {
      ...
      data['item_upload_config'] =
          ItemUploadConfig().fromMap(object.itemUploadConfig);
      ...
      data['package_in_app_purchased_prd_id_android'] =
          object.packageInAppPurchaseKeyInAndroid;
      data['package_in_app_purchased_prd_id_ios'] =
