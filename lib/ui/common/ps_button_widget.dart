        ...
        child: InkWell(
          ...
          child: Center(
            child: Container(
              ...
              child: Text(widget.titleText.toUpperCase(),
                  textAlign: widget.titleTextAlign,
                  style: Theme.of(context)
                      .textTheme
                      .labelLarge!
                      .copyWith(color: PsColors.white) //PsColors.white),
                  ),
            ),
          ),
        ),
...
class _PSButtonWithIconWidgetState extends State<PSButtonWithIconWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    _iconColor ??= PsColors.black;

    _color ??= PsColors.black;

    if (widget.gradient == null && _color == PsColors.black) {
      _gradient = LinearGradient(colors: <Color>[
        PsColors.black,
        PsColors.black,
      ]);
