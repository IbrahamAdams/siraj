  ...
  void initState() {
    _scrollController.addListener(() {
      if (_scrollController.position.pixels ==
        ...
        ratingProvider!
            .nextRatingList(ratingListHolder.toMap(), widget.itemUserId);
      }
    });
    animationController =
    ...
    return WillPopScope(
        ...
        child: PsWidgetWithAppBarWithTwoProvider<RatingListProvider,
            ...
            onProviderReady1: (RatingListProvider? provider) async {
              ...
              await provider!
                  .loadRatingList(ratingListHolder.toMap(), widget.itemUserId);
            },
            initProvider2: () {
              userProvider = UserProvider(
                    ...
                    child: RefreshIndicator(
                      child: CustomScrollView(
                        ...
                        slivers: <Widget>[
                          ...
                          if (ratingProvider.ratingList.data!.isNotEmpty)
                            SliverList(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  _RatingWidget(
                      ...
                      value: double.parse(userProvider
                          .user.data!.ratingDetail!.threeStarCount!),
                      percentage:
