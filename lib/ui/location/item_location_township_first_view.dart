...
class _ItemLocationTownshipFirstViewState
    extends State<ItemLocationTownshipFirstView> with TickerProviderStateMixin {
  _ItemLocationTownshipFirstViewState() {
    // searchBar = SearchBar(
    //     inBar: true,
  ...
  Widget build(BuildContext context) {
    ...
    return MultiProvider(
      ...
      child: Consumer<ItemLocationTownshipProvider>(builder:
          (BuildContext context, ItemLocationTownshipProvider provider,
              Widget? child) {
        return Scaffold(
    ...
    _widget ??= Column(
      ...
      children: <Widget>[
        ...
        Padding(
          ...
          child: Text(Utils.getString(context, 'Seletct Your Township'),
