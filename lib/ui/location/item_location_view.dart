  ...
  Widget build(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Container(
        ...
        child: Column(
          children: <Widget>[
            Container(color: PsColors.primary50, child: locationSVG),
            const SizedBox(
                    ...
                    child: PsTextFieldWidgetWithIcon2(
                      ...
                      onTap: () async {
                        ...
                        if (itemLocationResult != null &&
                          ...
                          _provider.itemLocationName = Utils.getString(
                          ...
                          if (_provider.itemLocationId != '') {
                            ...
                            final dynamic itemLocationResult =
                                await Navigator.pushNamed(context,
                                    RoutePaths.itemLocationTownshipFirst,
                            ...
                            if (itemLocationResult != null &&
                              ...
                              _provider.itemLocationTownshipId = '';
                              _provider.selectedTownshipName = Utils.getString(
                                  context, 'product_list__category_all');
                            }
                          } else {
                            showDialog<dynamic>(
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
          ...
          child: SvgPicture.asset('assets/images/loaction_illustration.svg',
