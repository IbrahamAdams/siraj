                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          _LinkAndTitle(
                              icon:
                                  FontAwesome.facebook, //FontAwesome.facebook,
                              title: Utils.getString(
                          ...
                          _LinkAndTitle(
                              icon: FontAwesome
                                  .twitter, //FontAwesome.twitter_square,
                              title: Utils.getString(
                          ...
                          _LinkAndTitle(
                              icon: FontAwesome.youtube, //FontAwesome.youtube,
                              title: Utils.getString(
            ...
            Column(
              ...
              children: <Widget>[
                ...
                InkWell(
                  ...
                  onTap: () async {
                    if (await canLaunchUrl(
                        Uri.parse('tel://${phone.aboutPhone}'))) {
