...
//                           maxLines: 1,
//                           style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: PsColors.secondary500),
//                         ),
//                         Padding(
                    ...
                    Visibility(
                      ...
                      child: Container(
                        margin: const EdgeInsets.only(
                            bottom: PsDimens.space1, right: PsDimens.space1),
                        width: 20,
                        height: 20,
                        //  padding: const EdgeInsets.all(PsDimens.space4),
                        decoration: BoxDecoration(
                        ...
                        Padding(
                          ...
                          child: Text(
                            ...
                            style: Theme.of(context)
                                ...
                                .copyWith(
                                    color: PsColors
                                        .textColor3), //PsColors.secondary300),
                          ),
                        ),
                      ],
                    ),
                  ...
                  children: <Widget>[
                    Text(
                      ...
                      style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                          color: PsColors.textColor1), //PsColors.primary500),
                    ),
                    const SizedBox(
                      width: PsDimens.space8,
                    ),
