    ...
    return Row(
      children: <Widget>[
        ...
        Expanded(
          child: InkWell(
            child: Text(
              "By clicking 'Sign up'' I agree that i have read and accepted the Terms of use.",
  ...
  Widget build(BuildContext context) {
    final Widget _textWidget = Text(
      ...
      style: Theme.of(context).textTheme.headlineSmall!.copyWith(
          fontWeight: FontWeight.bold, color: PsColors.labelLargeColor),
    );
    ...
    return Column(
      children: <Widget>[
        ...
        Container(
          height: 50,
          margin: const EdgeInsets.only(
              left: PsDimens.space52, right: PsDimens.space52),
          child: PSButtonWidget(
            ...
            onPressed: () async {
              print("" + widget.provider.isCheckBoxSelect.toString());
              if (widget.provider.isCheckBoxSelect == true) {
                ...
                if (emailController.text.isEmpty) {
                  ...
                  callWarningDialog(
                      context,
                      Utils.getString(
                          context, 'warning_dialog__input_password'));
                } else {
                  if (Utils.checkEmailFormat(emailController.text.trim())!) {
                    ...
                    callWarningDialog(
                        context,
                        Utils.getString(
                            context, 'warning_dialog__email_format'));
                  }
                }
              }
            },
        ...
        Container(
          ...
          child: PSButtonWidget(
            ...
            hasShadow: false,
            width: double.infinity,
            titleText: Utils.getString(context, 'login__sign_up'),
            onPressed: () async {
        ...
        Container(
          ...
          child: PSButtonWidget(
            ...
            hasShadow: false,
            width: double.infinity,
            titleText: Utils.getString(context, 'login__forgot_password'),
            onPressed: () async {
              Navigator.pushNamed(
                context,
    ...
    return Container(
        ...
        child: Directionality(
          ...
          child: apple.AppleSignInButton(
            // style: apple.labelLargeStyle.black, // style as needed
            // type: apple.labelLargeType.signIn, // style as needed
