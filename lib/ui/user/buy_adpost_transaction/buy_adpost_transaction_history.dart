...
import 'package:flutterbuyandsell/ui/package/package_recommended_shop_widget.dart';
                    ...
                    children: <Widget>[
                      Container(
                          ...
                          child: RefreshIndicator(
                                    ...
                                    SliverGrid(
                                      ...
                                      delegate: SliverChildBuilderDelegate(
                                        (BuildContext context, int index) {
                                          if (provider.transactionList.status ==
                            ...
                            onRefresh: () {
                              return provider.resetPackageTransactionDetailList(
                                packgageBoughtParameterHolder,
                              );
                            },
                          )),
