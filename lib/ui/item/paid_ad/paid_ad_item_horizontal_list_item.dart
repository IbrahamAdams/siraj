                            ...
                            Column(
                              ...
                              children: <Widget>[
                                ...
                                Visibility(
                                    ...
                                    maintainState: true,
                                    visible:
                                        paidAdItem.item!.discountRate != '0',
                                    child: Row(
                                      children: <Widget>[
                                        Text(
                                          '  ${paidAdItem.item!.itemCurrency!.currencySymbol}${Utils.getPriceFormat(paidAdItem.item!.price!, valueHolder.priceFormat!)}  ',
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        //   ),
                        // ),
                        Text(Utils.getString(context, 'profile__start_date'),
                            textAlign: TextAlign.start,
                            style: Theme.of(context)
                                .textTheme
                                .bodySmall!
                                .copyWith(
                                    color: PsColors.textColor2, fontSize: 9)),
                        Flexible(
                          child: Text(
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        //   ),
                        // ),
                        Text(Utils.getString(context, 'profile__end_date'),
                            textAlign: TextAlign.start,
                            style:
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: <Widget>[
                        ...
                        //   ),
                        // ),
                        Text(Utils.getString(context, 'profile__amount'),
                            textAlign: TextAlign.start,
                            style: Theme.of(context)
                                .textTheme
                                .bodySmall!
