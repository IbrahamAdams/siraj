...
import 'package:flutterbuyandsell/provider/product/reported_item_provider.dart';
...
class _ReportedItemListViewState extends State<ReportedItemListView>
  ...
  late ReportedItemProvider _userListProvider;
          ...
          child: Stack(children: <Widget>[
            Container(
                ...
                child: RefreshIndicator(
                  ...
                  onRefresh: () async {
                    return _userListProvider.resetReportedItemList(
