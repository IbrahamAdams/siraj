...
class PsUrl {
  ...
  static const String ps__sub_category_subscribe_url =
      'rest/subcat_subscribes/subcategory_subscribe/api_key/${PsConfig.ps_api_key}';
  ...
  static const String ps_buy_post_packgage_transaction_detail =
      'rest/buy_ad_post_transaction/search/api_key/${PsConfig.ps_api_key}';
  ...
  static const String ps_post_ps_user_apply_blue_mark_url =
      'rest/users/apply_blue_mark/api_key/${PsConfig.ps_api_key}';
