...
class PsColors {
  ...
  /// Primary Color
  static const Color _c_primary_50 = Color(0xFFFF9505);
  static const Color _c_primary_100 = Color(0xFFFF9505);
  static const Color _c_primary_200 = Color(0xFFFF9505);
  static const Color _c_primary_300 = Color(0xFFffffff);
  static const Color _c_primary_400 = Color(0xFFffffff);
  static const Color _c_primary_500 = Color(0xFFffffff);
  static const Color _c_primary_600 = Color(0xFFffffff);
  static const Color _c_primary_700 = Color(0xFFffffff);
  static const Color _c_primary_800 = Color(0xFFffffff);
  static const Color _c_primary_900 = Color(0xFFffffff);

  static const Color _c_primary_dark_dark = Color(0xFF303030);
  static const Color _c_primary_dark_accent = Color(0xFFffffff);
  ...
  static const Color _c_sold_out = Color(0xFFffffff);
  static const Color _c_item_type_color = Color(0xFFBDBDBD);

  static var labelLargeColor;
  ...
  static void _loadDarkColors() {
    ...
    textColor3 = const Color(0xFFffffff);
    textColor4 = const Color(0xFFffffff);

    ///
    /// Button Color
    ///
    buttonColor = const Color(0xFFFF9505);
    bottomNavigationSelectedColor = const Color(0xFFFF9505);
    activeColor = const Color(0xFFFF9505);
    backArrowColor = const Color(0xFFFF9505);
