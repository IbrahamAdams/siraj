...
import 'package:flutterbuyandsell/db/package_bought_transaction_dao.dart';
import 'package:flutterbuyandsell/viewobject/buyadpost_transaction.dart';
...
class PackageTranscationHistoryRepository extends PsRepository {
  ...
  void sinkCategoryListStream(
      StreamController<PsResource<List<PackageTransaction>>>?
  ...
  Future<dynamic> getPackageTransactionDetailList(
    ...
    if (isConnectedToInternet) {
      final PsResource<List<PackageTransaction>> _resource =
          await _psApiService.getPackageTransactionDetailList(
        holder.toMap(),
      );
      ...
      sinkCategoryListStream(
          transactionListStream, await _transactionDao.getAll());
    }
  }
